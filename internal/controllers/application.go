...
// +kubebuilder:rbac:groups=gateway.networking.k8s.io,resources=listenersets;httproutes;referencegrants,verbs=get;list;watch;create;update;patch;delete
...
func (r *ApplicationReconciler) Reconcile(ctx context.Context, req reconcile.Request) (reconcile.Result, error) {
	...
	if err := common.ValidateExtraContainers(application.Spec.ExtraContainers, application.Name, application); err != nil {

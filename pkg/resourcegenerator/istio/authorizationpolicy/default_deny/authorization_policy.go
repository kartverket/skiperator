...
func Generate(r reconciliation.Reconciliation) error {
	...
	if !ok {
		err := &reconciliation.SubResourceError{Message: "Failed to generate default AuthorizationPolicy", WrapErr: fmt.Errorf("failed to cast resource to application"), Reason: reconciliation.InternalError}
		return err
	}

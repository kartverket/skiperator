...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EntraIDClaims) DeepCopyInto(out *EntraIDClaims) {
	*out = *in
	if in.Groups != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EntraIDClaims.
func (in *EntraIDClaims) DeepCopy() *EntraIDClaims {
	if in == nil {
		return nil
	}
	out := new(EntraIDClaims)

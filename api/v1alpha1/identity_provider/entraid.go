...
func (i *EntraID) GetAuthSpec() *istiotypes.RequestAuth {
...
func (i *EntraID) GetAuthRules() istiotypes.RequestAuthRules {
...
func (i *EntraID) GetIgnoredAuthRules() istiotypes.RequestMatchers {
...
func (i *EntraID) GetAcceptedResources() []string {
